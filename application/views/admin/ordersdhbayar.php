            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">List Order Sudah Dibayar</h4>
                <a class='btn btn-warning' href='<?= site_url('admin/order_blm_bayar');?>'>Order Belum Dibayar</a>
                 <a class='btn btn-default' href='<?= site_url('admin/order_sdh_bayar');?>'>Order Sudah Dibayar</a>
...
switch (isset($product->status) ? $product->status : $product->payment_status) {
   ...
   case 2:
         ...
         break; 
                         ...
                         ?>
                         <a class='btn btn-success' href="<?= site_url('admin/accorder/'.$id_ord.'/2');?>">Klik Jika Sudah Approved</a>
