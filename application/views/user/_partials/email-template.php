...
<head>
    <title> Verifikasi Akun - Teledoctor.ID </title>
    <!--[if !mso]><!-- -->
...
<body style="background-color:deepskyblue; font-family: 'Poppins', sans-serif !important;">
    ...
    <div style="background-color:#E7E7E7;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            style="background:#040B4F;background-color:deepskyblue;width:100%;">
            <tbody>
                <tr>
                    <td>
                        <!--[if mso | IE]>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="width:600px;"> <a
                                                                                ...
                                                                                <img alt="" height="600"
                                                                                    src="https://Teledoctor.id/home/img/core-img/teldoc_white.PNG"
      ...
      >
        <tr>
          <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
      <![endif]-->
        <div style="background:#1f2e78;background-color:deepskyblue;margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                style="background:deepskyblue;background-color:deepskyblue;width:100%;">
                <tbody>
                    <tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    Teledoctor.ID - Verifikasi Akun</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    style="font-family: 'Poppins', sans-serif !important;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                                    Sebelum resmi menjadi user di website Teledoctor.ID,
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" bgcolor="#5e6ebf"
                                                                            role="presentation"
                                                                            style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:deepskyblue;"
                                                                            valign="middle"> <a
                                                                                href="<?php echo $link ?>"
                                                                                style="display:inline-block;width:250px;background:deepskyblue;color:#ffffff;font-family: 'Poppins', sans-serif !important;font-size:17px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;"
                                                                                target="_blank">
